...
class CalibrationImage:  # an adapter to allow zooming and hold other image data
    ...
    def __init__(self, image: ImageLoaded):
        ...
        # we don't want to handle interpolation for now
    ...
    def get_downscaled_cloud_and_indices(self):  # indices are the back reference to the image pixels
        ...
        cloud, _, indices = cloud.voxel_down_sample_and_trace(voxel_size=self._image.args.colour_rounding, min_bound=[0, -128, -128], max_bound=[100, 127, 127])
